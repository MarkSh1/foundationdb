...
m4 -DFDBVERSION=$VERSION -DFDBRELEASE=$RELEASE.el8 packaging/rpm/foundationdb.spec.in > $TEMPDIR/SPECS/foundationdb.el8.spec

fakeroot rpmbuild --quiet --define "%_topdir $TEMPDIR" -bb $TEMPDIR/SPECS/foundationdb.el8.spec
